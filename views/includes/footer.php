<footer class="w-full relative overflow-hidden  py-4 bg-gradient-to-tr from-blue-950 to-purple-600" data-aos="zoom-in"
    data-aos-anchor-placement="left-left" data-aos-duration="1200">
    ...
    <div class="md:px-12 lg:px-28">
        <div class="container m-auto space-y-6 text-white flex flex-col items-center">
            <div class="flex items-center">
                <img src="./assets/images/logo.svg" alt="logo wiki" class="w-20" />
                <span class="font-bold text-[2rem]">wiki</span>
            </div>
            <ul role="list" class="flex flex-col items-center justify-center gap-4 py-4 sm:flex-row sm:gap-8">
                <li role="listitem"><a href="#" class="hover:text-[#007FEC]">Home</a></li>
                <li role="listitem"><a href="#" class="hover:text-[#007FEC]">Features</a></li>
                <li role="listitem"><a href="#" class="hover:text-[#007FEC]">Get started</a></li>
                <li role="listitem"><a href="#" class="hover:text-[#007FEC]">About us</a></li>
            </ul>
            ...
            <div class="text-center">
                <span class="text-sm tracking-wide">Copyright © Wiki <span id="year"></span> | All right
                    reserved</span>
            </div>
        </div>
    </div>
